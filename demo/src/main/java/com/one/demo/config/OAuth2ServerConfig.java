...
import com.one.demo.exception.AuthExceptionEntryPoint;
import com.one.demo.exception.BootOAuth2WebResponseExceptionTranslator;
import com.one.demo.exception.CustomAccessDeniedHandler;
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(HttpSecurity http) throws Exception {
            http.authorizeRequests().antMatchers("/oauth/**").permitAll().and()
                    .authorizeRequests().antMatchers("/sysUser/**").authenticated().and()
